<template>
  <div>
    ...
    <blockquote class="blockquote">
      ...
      <img src="https://tfw.ostrov.ski" class="img-fluid" alt="tfw you understand Ed25519 key clamping"
    ...
    <p>For real realsies, setting one of higher bits to one <em>sort of</em> makes sense;
      ...
      (which were shown to be an effective attack vector for other cryptosystems, e.g., ECDSA).</p>
    <p class="small">Alternatively, setting lower bits is supposed to protect against
      ...
      where small-subgroup attacks make complete sense).</p>
  </div>
</template>
